const API_KEY = "3f67cd5a48msh4bf4f83094ead18p19b758jsn145d8831836e"; // Your API key
...
$(document).ready(function () {
    ...
    console.log("Adwit want to help you");
...
section	.rodata\n\
\n\
msg	db 'hello, Adwit', 0xa\n\
len	equ	$ - msg\n\
";

var bashSource = "echo \"hello, Adwit\"";

var basicSource = "PRINT \"hello, Adwit\"";

var cSource = "\
// Powered by Bhavy Sharma\n\
#include <stdio.h>\n\
\n\
int main(void) {\n\
    printf(\"Hello Adwit\\n\");\n\
...
public class Hello {\n\
    public static void Main() {\n\
        System.Console.WriteLine(\"hello, Adwit\");\n\
    }\n\
}\n\
";
...
var erlangSource = "\
main(_) ->\n\
    io:fwrite(\"hello, Adwit\\n\").\n\
";

var executableSource = "\
Adwit is a high level code editor which is made by Bhavy Sharma\n\
\n\
Here is an example of compiled \"hello, Adwit\" NASM program.\n\
...
public class Main {\n\
    public static void main(String[] args) {\n\
        System.out.println(\"hello, Adwit\");\n\
    }\n\
}\n\
";
...
var sqliteSource = "\
-- On Adwit Code Editor your SQL script is run on chinook database (https://www.sqlitetutorial.net/sqlite-sample-database).\n\
-- For more information about how to use SQL with Adwit please do this following :- \n\
...
Public Module Program\n\
   Public Sub Main()\n\
      Console.WriteLine(\"hello, Adwit\")\n\
   End Sub\n\
End Module\n\
";

var c3Source = "\
// On the Adwit code Editor, C3 is automatically\n\
...
var nimSource = "\
# On the Adwit COde Editor, Nim is automatically\n\
...
var bosqueSource = "\
// On the Adwit Code Editor, Bosque (https://github.com/microsoft/BosqueLanguage)\n\
